...
using (IRepository repository = Repository.Create("Data"))
{
    ...
    app.MapPost("/Celebrities", (Celebrity celebrity) =>
    {
        ...
        return new Celebrity((int)id, celebrity.Firstname, celebrity.Surname, celebrity.PhotoPath);
         ...
         .AddEndpointFilter(async (context, next) =>
         {
             ...
             // Первый фильтр
             // Если параметр celebrity == null, выбрасываем исключение
             if (celebrity == null)
             {
                 throw new ArgumentNullException("Celebrity parameter is null");
             }

             // Если Surname == null или его длина < 2, выбрасываем исключение
    ...
    .AddEndpointFilter(async (context, next) =>
    {
        ...
        // Если уже есть такая Surname, выбрасываем исключение
    ...
    .AddEndpointFilter(async (context, next) =>
    {
        ...
        // Если в BasePath нет файла с именем Path.GetFileName(celebrity.PhotoPath),
        // добавляем заголовок X-Celebrity: NotFound = Path.GetFileName(celebrity.PhotoPath)
